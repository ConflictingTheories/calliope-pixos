...
const App = () => {
  ...
  return (
    <React.Fragment>
      ...
      {/* Main Site Container */}
      <div className="pixos-admin">
        <Router>
          <Switch>
            <AuthenticatedRoute exact path="/editor" component={AdminScreen} />
      ...
      {/* Powered by Pixos and Date */}
      <p class="f">
        <span id="date">
          <a target="_blank" href="https://www.pixos.site">
            powered by Pixos ⚡⚡⚡
          </a>{' '}
          {date}
        </span>
