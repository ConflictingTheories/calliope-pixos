...
const DELETE_BUTTON_TOOLTIP = SHORTCUT_LABEL + ['Rücktaste', 'Entf'].join(KEYS_SEPARATOR_LABEL);
...
const OPTIONS_HIDE_TITLE_BAR_LABEL = 'Titelleiste ausblenden:';
const OPTIONS_SHOW_SUPPORT_PANEL_LABEL = 'Supportbereich anzeigen:';
