...
export default class PhysicsManager {
  ...
  addBody(
    ...
    width = null,
    height = null,
    layer = CollisionMask.Layers.DEFAULT,
    mask = CollisionMask.Layers.ALL
  ) {
  ...
  _resolveAABBCollision(body, aabb, other, otherAABB) {
    ...
    if (
      ...
      !otherAABB.min ||
      !otherAABB.max ||
      !(aabb.min instanceof Vector) ||
      !(aabb.max instanceof Vector) ||
      !(otherAABB.min instanceof Vector) ||
      !(otherAABB.max instanceof Vector) ||
      typeof aabb.min.x !== 'number' ||
      typeof aabb.min.y !== 'number' ||
      typeof aabb.min.z !== 'number' ||
      typeof aabb.max.x !== 'number' ||
      typeof aabb.max.y !== 'number' ||
      typeof aabb.max.z !== 'number' ||
      typeof otherAABB.min.x !== 'number' ||
      typeof otherAABB.min.y !== 'number' ||
      typeof otherAABB.min.z !== 'number' ||
      typeof otherAABB.max.x !== 'number' ||
      typeof otherAABB.max.y !== 'number' ||
      typeof otherAABB.max.z !== 'number'
    ) {
      return;
    }
    ...
    if (
      !aabb.getCenter ||
      typeof aabb.getCenter !== 'function' ||
      !otherAABB.getCenter ||
      typeof otherAABB.getCenter !== 'function'
    ) {
      return;
    }
    ...
    if (
      ...
      !otherCenter ||
      typeof otherCenter.x !== 'number' ||
      typeof otherCenter.y !== 'number' ||
      typeof otherCenter.z !== 'number'
    ) {
      return;
    }
