...
const DEFAULT_NODE_DATA = {
  ...
  choice: { prompt: '', options: [{ text: 'Option 1', targetId: null }, { text: 'Option 2', targetId: null }] },
    ...
    return (
      ...
      >
        ...
        <div className="bd-node__body">
              ...
              {node.data.options?.map((opt, i) => (
                <div key={i} className="bd-node__option">
                  ...
                  <button
                    ...
                    onClick={(e) => { e.stopPropagation(); startConnection(node.id, i); }}
            ...
            <div className="bd-node__condition">
              ...
              <div className="bd-node__condition-branches">
                <button
                  ...
                  onClick={(e) => { e.stopPropagation(); startConnection(node.id, 0); }}
                ...
                <button
                  ...
                  onClick={(e) => { e.stopPropagation(); startConnection(node.id, 1); }}
          ...
          {node.type === 'end' && (
            <div className="bd-node__end">Scene End</div>
          )}
        </div>
    ...
    <div className={`branching-dialogue ${className}`}>
      ...
      <div className="bd-toolbar">
        <ButtonGroup size="xs">
          ...
          <Button onClick={handleExport} disabled={nodes.length === 0}>Export DSL</Button>
        </ButtonGroup>
        <div className="bd-toolbar__zoom">
          <Button size="xs" onClick={() => setZoom(z => Math.max(0.25, z - 0.1))}>−</Button>
          <span>{Math.round(zoom * 100)}%</span>
          <Button size="xs" onClick={() => setZoom(z => Math.min(2, z + 0.1))}>+</Button>
        </div>
      </div>
      ...
      {selectedNode && (
        <div className="bd-properties">
          <div className="bd-properties__header">
            <span>{NODE_TYPES[selectedNode.type]?.icon} {NODE_TYPES[selectedNode.type]?.label}</span>
          </div>
              ...
              <>
                ...
                <div className="bd-field">
                  ...
                  <Button
                    size="xs"
                    onClick={() => {
                      const newOpts = [...(selectedNode.data.options || []), { text: 'New Option', targetId: null }];
                      updateNodeData(selectedNodeId, { options: newOpts });
                    }}
                  >
                    + Add Option
