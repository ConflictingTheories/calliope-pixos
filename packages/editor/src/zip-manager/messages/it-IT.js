...
const OPTIONS_HIDE_TITLE_BAR_LABEL = 'Nascondi barra del titolo:';
const OPTIONS_SHOW_SUPPORT_PANEL_LABEL = 'Mostra pannello di supporto:';
...
const CHOOSE_ACTION_LABEL = "È stato selezionato un file zip, scegli l'azione appropriata.";
const NO_ENTRIES_LABEL = 'Trascina qui file e cartelle';
const INFO_LABEL = ['Codice sorgente su ', ' GitHub ', ' Creato con ', '♡', ' a ', 'Rennes'];
