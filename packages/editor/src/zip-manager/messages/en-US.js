...
const OPTIONS_HIDE_TITLE_BAR_LABEL = 'Hide title bar:';
const OPTIONS_SHOW_SUPPORT_PANEL_LABEL = 'Show support panel:';
...
const CHOOSE_ACTION_LABEL = 'A zip file has been selected, please choose the proper action.';
const NO_ENTRIES_LABEL = 'Drag and drop files and directories here';
const INFO_LABEL = ['Thank you for using PixoSpritz', ' Made with ', '♡', ' in ', 'Canada'];
const CITY_URL = 'https://en.wikipedia.org/wiki/Calgary';
