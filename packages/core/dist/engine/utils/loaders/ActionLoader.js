...
var ActionLoader = exports.ActionLoader = /*#__PURE__*/function () {
  function ActionLoader(engine, type, args, sprite, callback) {
    ...
    return this.load(type, /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(action) {
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              _context.n = 1;
              return action.onLoad(args);
            case 1:
              return _context.a(2);
          }
        }, _callee);
  ...
  return _createClass(ActionLoader, [{
    key: "load",
    value: function () {
      var _load = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(type) {
        var afterLoad,
          runConfigure,
          instance,
          _args3 = arguments;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.n) {
            case 0:
              ...
              // Notify existing
              _context3.n = 1;
              return Promise.all(this.instances[type].map(/*#__PURE__*/function () {
                var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(instance) {
