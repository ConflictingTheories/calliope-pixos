...
var _object = _interopRequireDefault(require("@Engine/core/resource/object.js"));
...
\*                                                 */
//helps load models
var ObjectLoader = exports.ObjectLoader = /*#__PURE__*/function () {
  ...
  return _createClass(ObjectLoader, [{
    key: "loadFromZip",
    value: function () {
      var _loadFromZip = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(zip, model) {
        var _model$mtl;
        var afterLoad,
          runConfigure,
          instance,
