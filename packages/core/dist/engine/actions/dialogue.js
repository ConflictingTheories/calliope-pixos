...
var _default = exports["default"] = {
  ...
  tick: function tick(time) {
    ...
    if (this.options && this.options.autoclose) {
      var _this$options$endTime, _ref;
      this.endTime = this.endTime ? this.endTime : (_this$options$endTime = this.options.endTime) !== null && _this$options$endTime !== void 0 ? _this$options$endTime : new Date().getTime() + ((_ref = this.options.duration * 1000) !== null && _ref !== void 0 ? _ref : 10000); // 10 seconds default if autoclose
