...
var _default = exports["default"] = {
  ...
  tick: function tick(time) {
    ...
    if (time >= endTime) {
      ...
      var _hx = this.sprite.pos.x + this.sprite.hotspotOffset.x;
      var _hy = this.sprite.pos.y + this.sprite.hotspotOffset.y;
      this.sprite.pos.z = this.sprite.zone.getHeight(_hx, _hy);
      // Get next frame
      var _newFrame = Math.floor(frac * 4);
      if (_newFrame != this.sprite.animFrame) this.sprite.setFrame(_newFrame);
    }
    return false;
  },
  // Trigger interactions in sprite when finished moving
  onStep: function () {
    var _onStep = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        ...
        while (1) switch (_context2.n) {
          case 0:
            ...
            return Promise.all(this.spriteList.map(/*#__PURE__*/function () {
              var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(sprite) {
                var _t;
                return _regenerator().w(function (_context) {
                  while (1) switch (_context.n) {
                    case 0:
                      ...
                      _context.n = 1;
                      return sprite.onStep(sprite, sprite);
                    case 1:
                      _t = _context.v;
                      _context.n = 3;
                      break;
    ...
    function onStep() {
      return _onStep.apply(this, arguments);
    }
    return onStep;
  }()
};