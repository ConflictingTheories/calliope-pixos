...
var ModeManager = exports["default"] = /*#__PURE__*/function () {
  ...
  return _createClass(ModeManager, [{
    ...
    key: "set",
    value: (function () {
      var _set = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(name) {
        var _this$currentMode$han;
        var params,
          handlers,
          res,
          _args2 = arguments,
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 1:
              if (!(this.currentMode && (_this$currentMode$han = this.currentMode.handlers) !== null && _this$currentMode$han !== void 0 && _this$currentMode$han.teardown)) {
                _context2.n = 5;
                break;
              }
              _context2.p = 2;
              _context2.n = 3;
              return this.currentMode.handlers.teardown(params);
            case 3:
              _context2.n = 5;
              break;
            case 4:
              _context2.p = 4;
              _t2 = _context2.v;
              console.warn("Mode teardown failed for mode \"".concat(this.currentMode.name, "\":"), _t2);
            case 5:
              if (!this.registered[name]) {
                console.warn("Warning: Mode \"".concat(name, "\" has not been registered."));
              }
    ...
    key: "update",
    value: (function () {
      var _update = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(time) {
        var h, _t4;
