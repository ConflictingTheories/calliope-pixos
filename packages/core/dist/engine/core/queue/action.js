 ...
 */
var Action = exports["default"] = /*#__PURE__*/function () {
  /**
   ...
   */
  function Action(type, sprite, callback) {
  ...
  return _createClass(Action, [{
    ...
    key: "onLoad",
    value: (function () {
      var _onLoad = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(args) {
