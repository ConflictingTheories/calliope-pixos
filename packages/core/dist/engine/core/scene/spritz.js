...
var _fs = _interopRequireDefault(require("@Engine/shaders/fs.js"));
var _vs = _interopRequireDefault(require("@Engine/shaders/vs.js"));
...
// Spritz Object
var Spritz = exports["default"] = /*#__PURE__*/_createClass(
/**
...
function Spritz() {
  var _this = this;
  _classCallCheck(this, Spritz);
  /**
   * Init Spritz
   * @param {*} engine
   */
  _defineProperty(this, "init", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(engine) {
      var world;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            ...
            world = Spritz._instance.world = new _world["default"](Spritz._instance, 'spritz'); // Load Zones - TODO - Add injection / Props to make more Dynamic
   ...
   * @param {string} src
   */
  _defineProperty(this, "loadSpritzManifest", /*#__PURE__*/function () {
  ...
  _defineProperty(this, "loadAvatar", /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(src, zoneId) {
   ...
   * Todo - Load avatar into spritz
   */
  _defineProperty(this, "exportAvatar", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
    var zip, avatar, blob;
   ...
   * @param {number} now
   */
  _defineProperty(this, "update", function (now) {
    // Build
