...
** ----------------------------------------------- **
\*                                                 */
var PixoScriptInterpreter = exports["default"] = /*#__PURE__*/_createClass(function PixoScriptInterpreter(engine) {
  var _this = this;
  _classCallCheck(this, PixoScriptInterpreter);
  _defineProperty(this, "setScope", function (scope) {
    _this.scope = scope;
  });
  ...
  _defineProperty(this, "initLibrary", function () {
    if (!_this.env) _this.createEnv();
    _this.library = _this.pixosLib.getLibrary(_this.engine, _this.scope);
    _this.env.loadLib('pixos', _this.library);
  });
  _defineProperty(this, "run", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(script) {
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            if (!_this.env) _this.createEnv();
            if (!_this.library) _this.initLibrary();
            return _context.a(2, _this.env.parse(script).exec());
        }
      }, _callee);
    }));
    return function (_x) {
  ...
  this.pixosLib = new _PixoScriptLibrary["default"](this.pixoscript);
  this.scope = {};
  this.env = null;
  this.library = null;
