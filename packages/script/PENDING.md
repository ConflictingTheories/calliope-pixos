...
- Expand test coverage for parser and runtime
- Implement Coroutines (async generators for Lua-style coroutines).
- Generate Source Maps for error reporting.
- Build a Debug Library (`debug.sethook`, `debug.getinfo`, `debug.traceback`).
