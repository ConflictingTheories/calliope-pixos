import { MetaMethods, Table } from './Table.js';
import { coerceToNumber, coerceToString, LuaType, coerceToBoolean } from './utils.js';
...
// binary
const add = (left: LuaType, right: LuaType): number =>
  binaryArithmetic(left, right, '__add', (l, r) => l + r);

const sub = (left: LuaType, right: LuaType): number =>
  binaryArithmetic(left, right, '__sub', (l, r) => l - r);

const mul = (left: LuaType, right: LuaType): number =>
  binaryArithmetic(left, right, '__mul', (l, r) => l * r);
...
const pow = (left: LuaType, right: LuaType): number =>
  binaryArithmetic(left, right, '__pow', Math.pow);
...
const band = (left: LuaType, right: LuaType): number =>
  binaryArithmetic(left, right, '__band', (l, r) => l & r);

const bor = (left: LuaType, right: LuaType): number =>
  binaryArithmetic(left, right, '__bor', (l, r) => l | r);

const bxor = (left: LuaType, right: LuaType): number =>
  binaryArithmetic(left, right, '__bxor', (l, r) => l ^ r);

const shl = (left: LuaType, right: LuaType): number =>
  binaryArithmetic(left, right, '__shl', (l, r) => l << r);

const shr = (left: LuaType, right: LuaType): number =>
  binaryArithmetic(left, right, '__shr', (l, r) => l >> r);
...
const lt = (left: LuaType, right: LuaType): boolean =>
  binaryBooleanArithmetic(left, right, '__lt', (l, r) => l < r);

const le = (left: LuaType, right: LuaType): boolean =>
  binaryBooleanArithmetic(left, right, '__le', (l, r) => l <= r);
