...
export class SourceMapConsumer {
  ...
  originalPositionFor(generated: { line: number, column: number }): {
    ...
    const mapping = this.decodedMappings.find(m =>
      m.generatedLine === generated.line &&
      m.generatedColumn <= generated.column
    )
    ...
    return {
      ...
      name: mapping.nameIndex !== undefined
        ? this.sourceMap.names[mapping.nameIndex]
        : null
    }
  }
...
libSourceMap.rawset('generator', (file?: string, sourceRoot?: string) => {
  ...
  table.rawset('addMapping', (genLine: number, genCol: number, source: string,
                               origLine: number, origCol: number, name?: string) => {
    gen.addMapping({
...
libSourceMap.rawset('consumer', (sourceMapJSON: string) => {
  ...
  table.rawset('sourceContentFor', (source: string) =>
