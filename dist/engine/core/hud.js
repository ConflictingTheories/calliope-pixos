...
var minecraftia = new FontFace("minecraftia", "url(/pixos/font/minecraftia.ttf)"); // Scrolling Text Box UI (For Dialogue)
...
var textScrollBox = /*#__PURE__*/function () {
  ...
  _createClass(textScrollBox, [{
    ...
    value: function init(text, x, y, width, height) {
      ...
      this.width = width;
      this.height = height;
      this.portrait = (_options$portrait = options.portrait) !== null && _options$portrait !== void 0 ? _options$portrait : null;
    ...
    value: function render() {
      ...
      this.drawScrollBox(); // Important text does not like being place at fractions of a pixel
