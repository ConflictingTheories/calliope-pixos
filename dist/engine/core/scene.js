...
var _fs = _interopRequireDefault(require("@Engine/shaders/fs.jsx"));

var _vs = _interopRequireDefault(require("@Engine/shaders/vs.jsx"));

var _world = _interopRequireDefault(require("@Engine/core/world.jsx"));
...
var Scene = /*#__PURE__*/_createClass(function Scene() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              world = Scene._instance.world = new _world["default"](engine, "scene"); // Load Zones - TODO - Add injection / Props to make more Dynamic
              ...
              world.startMenu({
                start: {
                  ...
                  trigger: function trigger(menu) {
                    // on Click
                    console.log(menu); // Unpause Gameplay

                    menu.world.isPaused = false; // Exit Menu
  ...
  _defineProperty(this, "loadSceneManifest", /*#__PURE__*/function () {
  ...
  _defineProperty(this, "loadAvatar", /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(src, zoneId) {
  ...
  _defineProperty(this, "exportAvatar", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var zip, avatar, blob;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            zip.folder("pixos").file("avatar.json", JSON.stringify(avatar)); // save
          ...
          case 5:
            blob = _context4.sent;
            (0, _fileSaver.saveAs)(blob, "avatar.zip");
  ...
  _defineProperty(this, "render", function (engine, now) {
    // Build
    Scene._instance.world.tickOuter(now); // Draw Frame
  ...
  _defineProperty(this, "onTouchEvent", function (e) {
    switch (e.type) {
      case "mousedown":
      case "mouseup":
      case "mousemove":
