...
\*                                                 */
var _default = {
  init: function init(triggerId, zone) {
    ...
    this.onCompleted = function () {
      return console.log("script finished");
    };

    if (onCompleted) this.onCompleted = onCompleted; // Determine Tile

    this.triggerId = triggerId; // Trigger

    this.triggerScript();
  },
  // Trigger interactions in sprites
  triggerScript: function triggerScript() {
    var _this = this;

    if (!this.triggerId) this.completed = true;
    Promise.all(this.zone.scripts.filter(function (x) {
      return x.id === _this.triggerId;
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return x.trigger.call(_this.zone);
