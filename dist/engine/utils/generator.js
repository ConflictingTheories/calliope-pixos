...
// Store Name
var STORE_NAME = "garden-tome"; // generate random map zone
...
function _generateZone() {
  _generateZone = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(self, gender, storeName, cyoa) {
    var tome, scene;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            tome = self.engine.fetchStore(storeName);
            ...
            self.engine.addStore(storeName, tome); // Generate a collection of scenes programmably
            // and append them to the scenes collection.
            // self.randomlyGenerateSprites();
            // self.randomlySprites();

            _context4.next = 7;
            return self.playScene("welcome");
          ...
          case 13:
            ...
            return Promise.all(tome.npcs.filter(function (x) {
              ...
              var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(trigger) {
          ...
          case 15:
            ...
            return Promise.all(tome.triggers.filter(function (x) {
              ...
              var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(trigger) {
          ...
          case 17:
            _context4.next = 19;
            return Promise.all(tome.scenes.filter(function (x) {
              return x.id == tome.selected;
            }).map( /*#__PURE__*/function () {
                ...
                return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        _context3.next = 2;
                        return self.playScene(scene.id, tome.scenes);
          ...
          case 19:
            ...
            _context4.next = 22;
            return self.playScene(scene[0].id, scene);
...
function _loadAvatar() {
  _loadAvatar = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(zone, storeName) {
