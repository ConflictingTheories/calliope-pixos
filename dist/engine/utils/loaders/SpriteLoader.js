...
var _tileset = _interopRequireDefault(require("@Engine/core/tileset.jsx"));
...
var SpriteLoader = /*#__PURE__*/function () {
  ...
  _createClass(SpriteLoader, [{
    key: "load",
    value: function () {
      var _load = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(type, sceneName) {
        var afterLoad,
            runConfigure,
            Type,
            instance,
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                Type = require("@Scenes/" + sceneName + "/sprites/" + type + ".jsx")["default"];
