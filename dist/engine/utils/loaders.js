...
exports.TilesetLoader = exports.SpriteLoader = exports.ObjectLoader = exports.AudioLoader = exports.ActionLoader = void 0;

var _resources = _interopRequireDefault(require("./resources.jsx"));

var _sprite = _interopRequireDefault(require("../core/sprite.jsx"));

var _object = _interopRequireDefault(require("../core/object.jsx"));

var _tileset = _interopRequireDefault(require("../core/tileset.jsx"));

var _action = _interopRequireDefault(require("../core/action.jsx"));
...
var SCENE_SET = "default"; // default || peacefulGarden
...
var TilesetLoader = /*#__PURE__*/function () {
  ...
  _createClass(TilesetLoader, [{
    key: "loadRemote",
    value: function () {
      var _loadRemote = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name) {
    ...
    key: "load",
    value: function () {
      var _load = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(type) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                json = require("../../scenes/" + SCENE_SET + "/tilesets/" + type + "/tileset.jsx")["default"];
...
var SpriteLoader = /*#__PURE__*/function () {
  ...
  _createClass(SpriteLoader, [{
    key: "load",
    value: function () {
      var _load2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(type) {
        var afterLoad,
            runConfigure,
            Type,
            instance,
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                Type = require("../../scenes/" + SCENE_SET + "/sprites/" + type + ".jsx")["default"];
                console.log(Type, type);
                instance = new Type(this.engine);
...
var ObjectLoader = /*#__PURE__*/function () {
  ...
  _createClass(ObjectLoader, [{
    key: "load",
    value: function () {
      var _load3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(model) {
        var _model$mtl;
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                afterLoad = _args4[1];
                runConfigure = _args4[2];

                if (!this.instances[model.id]) {
                  this.instances[model.id] = [];
                }

                instance = new _object["default"](this.engine);
                instance.update(model); // New Instance

                modelreq = {
                  obj: "pixos/models/".concat(instance.type, ".obj"),
                  mtl: (_model$mtl = model.mtl) !== null && _model$mtl !== void 0 ? _model$mtl : false,
                ...
                _context4.next = 8;
                return this.engine.objLoader.downloadModels(this.engine.gl, [modelreq]);
              ...
              case 8:
                ...
                console.log("loaded model", instance); // Update Existing
                ...
                if (afterLoad) {
                  console.log("after load");
                  if (instance.templateLoaded) afterLoad(instance);else this.instances[instance.id].push({
                    instance: instance,
                    afterLoad: afterLoad
                  });
                }
