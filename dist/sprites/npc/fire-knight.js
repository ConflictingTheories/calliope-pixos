...
var FireKnight = /*#__PURE__*/function (_NPC) {
  _inherits(FireKnight, _NPC);

  var _super = _createSuper(FireKnight);

  function FireKnight(engine) {
    var _this;

    _classCallCheck(this, FireKnight);

    // Initialize Sprite
    _this = _super.call(this, engine); // Character art from http://opengameart.org/content/chara-seth-scorpio

    _this.src = _resources["default"].artResourceUrl("fire-knight.gif");
    _this.portraitSrc = _resources["default"].artResourceUrl("fire_portrait.gif");
  ...
  return _createClass(FireKnight);
}(_NPC2["default"]);

exports["default"] = FireKnight;