...
var Darkness = /*#__PURE__*/function (_NPC) {
  _inherits(Darkness, _NPC);

  var _super = _createSuper(Darkness);

  function Darkness(engine) {
    var _this;

    _classCallCheck(this, Darkness);

    // Initialize Sprite
    _this = _super.call(this, engine); // Character art from http://opengameart.org/content/chara-seth-scorpio

    _this.src = _resources["default"].artResourceUrl("darkness.gif");
    _this.portraitSrc = _resources["default"].artResourceUrl("dark_portrait.gif");
  ...
  return _createClass(Darkness);
}(_NPC2["default"]);

exports["default"] = Darkness;