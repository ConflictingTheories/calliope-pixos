...
var WaterKnight = /*#__PURE__*/function (_NPC) {
  _inherits(WaterKnight, _NPC);

  var _super = _createSuper(WaterKnight);

  function WaterKnight(engine) {
    var _this;

    _classCallCheck(this, WaterKnight);

    // Initialize Sprite
    _this = _super.call(this, engine); // Character art from http://opengameart.org/content/chara-seth-scorpio

    _this.src = _resources["default"].artResourceUrl("water-knight.gif");
    _this.portraitSrc = _resources["default"].artResourceUrl("water_portrait.gif");
  ...
  return _createClass(WaterKnight);
}(_NPC2["default"]);

exports["default"] = WaterKnight;