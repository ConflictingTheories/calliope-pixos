...
var AirKnight = /*#__PURE__*/function (_NPC) {
  _inherits(AirKnight, _NPC);

  var _super = _createSuper(AirKnight);

  function AirKnight(engine) {
    var _this;

    _classCallCheck(this, AirKnight);

    // Initialize Sprite
    _this = _super.call(this, engine); // Character art from http://opengameart.org/content/chara-seth-scorpio

    _this.src = _resources["default"].artResourceUrl("air-knight.gif");
    _this.portraitSrc = _resources["default"].artResourceUrl("air_portrait.gif");
  ...
  return _createClass(AirKnight);
}(_NPC2["default"]);

exports["default"] = AirKnight;