...
var _NPC2 = _interopRequireDefault(require("./base/NPC.jsx"));
...
var EarthKnight = /*#__PURE__*/function (_NPC) {
  _inherits(EarthKnight, _NPC);

  var _super = _createSuper(EarthKnight);

  function EarthKnight(engine) {
    var _this;

    _classCallCheck(this, EarthKnight);

    // Initialize Sprite
    _this = _super.call(this, engine); // Character art from http://opengameart.org/content/chara-seth-scorpio

    _this.src = _resources["default"].artResourceUrl("earth-knight.gif");
    _this.portraitSrc = _resources["default"].artResourceUrl("earth_portrait.gif");
    _this.sheetSize = [128, 256];
    _this.tileSize = [24, 32]; // Offsets
  ...
  return _createClass(EarthKnight);
}(_NPC2["default"]);

exports["default"] = EarthKnight;