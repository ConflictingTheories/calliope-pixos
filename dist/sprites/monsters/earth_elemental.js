...
var EarthElemental = /*#__PURE__*/function (_Sprite) {
  _inherits(EarthElemental, _Sprite);

  var _super = _createSuper(EarthElemental);

  function EarthElemental(engine) {
    var _this;

    _classCallCheck(this, EarthElemental);
  ...
  return _createClass(EarthElemental);
}(_sprite["default"]);

exports["default"] = EarthElemental;