...
var FireElemental = /*#__PURE__*/function (_Sprite) {
  _inherits(FireElemental, _Sprite);

  var _super = _createSuper(FireElemental);

  function FireElemental(engine) {
    var _this;

    _classCallCheck(this, FireElemental);
  ...
  return _createClass(FireElemental);
}(_sprite["default"]);

exports["default"] = FireElemental;