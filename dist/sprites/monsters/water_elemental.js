...
var WaterElemental = /*#__PURE__*/function (_Sprite) {
  _inherits(WaterElemental, _Sprite);

  var _super = _createSuper(WaterElemental);

  function WaterElemental(engine) {
    var _this;

    _classCallCheck(this, WaterElemental);

    // Initialize Sprite
    _this = _super.call(this, engine); // Character art from http://opengameart.org/content/chara-seth-scorpio

    _this.src = _resources["default"].artResourceUrl("elementals.gif");
  ...
  return _createClass(WaterElemental);
}(_sprite["default"]);

exports["default"] = WaterElemental;