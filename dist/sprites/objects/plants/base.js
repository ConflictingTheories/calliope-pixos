...
var Plant = /*#__PURE__*/function (_Sprite) {
  _inherits(Plant, _Sprite);

  var _super = _createSuper(Plant);

  function Plant(engine) {
    var _this;

    _classCallCheck(this, Plant);

    // Initialize Sprite
    _this = _super.call(this, engine); // Should the camera follow the avatar?
