...
var RedChest = /*#__PURE__*/function (_Chest) {
  _inherits(RedChest, _Chest);

  var _super = _createSuper(RedChest);

  function RedChest(engine) {
    var _this;

    _classCallCheck(this, RedChest);
    ...
    _this.frames = {
      down: [[32, 0], [32, 24], [32, 48], [32, 72]],
      right: [[96, 0], [96, 24], [96, 48], [96, 72]],
      up: [[32, 96], [32, 120], [32, 144], [32, 168]],
      left: [[160, 0], [160, 24], [160, 48], [160, 72]]
  ...
  return _createClass(RedChest);
}(_base["default"]);

exports["default"] = RedChest;