...
var IronChest = /*#__PURE__*/function (_Chest) {
  _inherits(IronChest, _Chest);

  var _super = _createSuper(IronChest);

  function IronChest(engine) {
    var _this;

    _classCallCheck(this, IronChest);
    ...
    _this.frames = {
      down: [[16, 0], [16, 24], [16, 48], [16, 72]],
      right: [[80, 0], [80, 24], [80, 48], [80, 72]],
      up: [[16, 96], [16, 120], [16, 144], [16, 168]],
      left: [[144, 0], [144, 24], [144, 48], [144, 72]]
  ...
  return _createClass(IronChest);
}(_base["default"]);

exports["default"] = IronChest;