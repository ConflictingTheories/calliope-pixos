...
var Chest = /*#__PURE__*/function (_Sprite) {
  _inherits(Chest, _Sprite);

  var _super = _createSuper(Chest);

  function Chest(engine) {
    var _this;
      ...
      switch (this.state) {
        case "closed":
          ...
          ret = new _index.ActionLoader(this.engine, "animate", [600, 3, function () {
            if (sprite.inventory) {
              var _sprite$inventory;

              (_sprite$inventory = sprite.inventory).push.apply(_sprite$inventory, _toConsumableArray(_this2.inventory));
            }
        ...
        case "open":
          this.state = "open";
          ret = new _index.ActionLoader(this.engine, "dialogue", ["Empty.", false, {
            autoclose: true,
