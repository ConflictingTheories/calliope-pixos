...
var Door = /*#__PURE__*/function (_Sprite) {
  _inherits(Door, _Sprite);

  var _super = _createSuper(Door);

  function Door(engine) {
    var _this;
    ...
    value: function interact(sprite, finish) {
      ...
      switch (this.state) {
        case "closed":
          ...
          this.blocking = false;
          this.override = true;
          ret = new _index.ActionLoader(this.engine, "animate", [600, 3, function () {
            finish(true);
          }], this);
          break;
        ...
        case "open":
          this.state = "open";
          ret = new _index.ActionLoader(this.engine, "dialogue", ["Its already Open!.", false, {
            autoclose: true,
