...
var _earthKnight = _interopRequireDefault(require("@Sprites/npc/earth-knight.jsx"));
...
var MyEarthKnight = /*#__PURE__*/function (_EarthKnight) {
  _inherits(MyEarthKnight, _EarthKnight);

  var _super = _createSuper(MyEarthKnight);

  function MyEarthKnight(engine) {
    _classCallCheck(this, MyEarthKnight);
  ...
  _createClass(MyEarthKnight, [{
    ...
    value: function interact(sprite, finish) {
      ...
      switch (this.state) {
        case "intro":
          this.state = "loop";
          ret = new _index.ActionLoader(this.engine, "dialogue", ["Welcome!", false, {
            autoclose: true,
  ...
  return MyEarthKnight;
}(_earthKnight["default"]);

exports["default"] = MyEarthKnight;